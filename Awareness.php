 ...
 <head>
    ...
    <body>
      ...
      $query = mysqli_query($conn,$sql);
        ...
        while($row = mysqli_fetch_array($query))
         {
          ?>
          <form action="ga_result.php" method="post">
          <div class="box">
  ...
  <?php
      ...
      <button type="submit" class='btn btn-warning' name="submit"  value="submit" >Submit Above section</button>
          ...
          <br>
          <center>
      <a href="report.php?id=<?php echo $_SESSION['name']; ?>"><button type="submit" class='btn btn-info' name="result"  value="submit" >
          Final Submission</button>
          </a>

        <br>
          <h4>Note:[ kindly submit and then move to other section ]</h4>
          </center>
            <!-- </div> -->

...
<html lang="en" dir="ltr">
  ...
  <body>
    <h4><i>General English</i></h4>
    <br>
    <?php
        $conn = mysqli_connect('localhost','root','','online');
        $sql = "select * from genglish";
...
<!-- --------------- -->
    ...
    <h4><i>Quantative Aptitude</i></h4>
    <br>
      <?php
      $sql = "select * from qaptitude ";
      $query = mysqli_query($conn,$sql);
      // -----------
      // echo '<br> GE <br>';
            if(mysqli_num_rows($query)>0) {
...
<!-- ------------------ -->
    ...
    <h4><i>Logical Reasoning</i></h4>
    <br>
      <?php
      $sql = "select * from lreasoning ";
      $query = mysqli_query($conn,$sql);
      // -----------
      // echo '<br> GE <br>';
            if(mysqli_num_rows($query)>0) {
...
<!-- -------------- -->
        ...
        <h4><i>General Awareness</i></h4>
        <br>
          <?php
          $sql = "select * from gawareness ";
          $query = mysqli_query($conn,$sql);
          // -----------
          // echo '<br> GE <br>';
                if(mysqli_num_rows($query)>0) {
          ...
          <center><a href="adminDB.php">
          <button type='button' name='btn' class="btn btn-info">Previous Page</button>
            </a>
                <br><br>
                <a href="adminLogout.php">
          <button type='button' name='btn' class="btn btn-warning">Logout</button></a>
        </a>
          </center>
                    <br>
      </body>
